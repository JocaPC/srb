...
as begin
	...
	exec srb.trigger_dialog @dialog, 5; -- trigger the dialog again after 5 seconds
end;
go
...
exec srb.trigger_conversation 'Sender', 'Receiver', 10
...
exec srb.end_conversation 'Sender', 'Receiver', 1;
exec srb.drop_service 'Sender';
exec srb.drop_service 'Receiver';

exec srb.end_conversation 'Receiver', 'Sender', 1;